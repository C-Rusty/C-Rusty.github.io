        ...
        >
            <Box className="modal-legal__inner">
                <div className="container">
                    ...
                    <div className="paragraph">
                        <p className="header">{t (`Personal data we collect`)}</p>
                        <p className="text">{t (`The types of personal data that we may process, for instance, include information about current, past and prospective clients and customers, Website visitors, etc. with whom we deal. This information includes information required to communicate with you, including but not limited to:`)}</p>
                        <ul className="list">
                           <li>{t (`Name`)};</li>
                           <li>{t (`Surname`)};</li>
                           <li>{t (`Social media account information (phone number and/or your social media account`)};</li>
                        </ul>
                        <p className="text">{t (`The personal data we collect depends on the context of your interactions with us, the choices you make, including your privacy settings, and the service you use.`)}</p>
                    </div>
                    <div className="paragraph">
                    ...
                    <div className="paragraph">
                        <p className="header">{t (`Data Storage`)}</p>
                        <p className="text">{t (`All collected data is stored on servers located within the European Union, ensuring compliance with GDPR requirements.`)}</p>
                        <p className="text">{t (`We may transfer your personal data from the European Union to other countries, some of which have not been determined by the European Commission to have an adequate level of data protection. When we do, we use a variety of mechanisms to help ensure your rights and the protection of your personal data.`)}</p>
                        <p className="text">{t (`We are retaining your personal data for as long as necessary to provide the services, or for other essential purposes such as complying with our legal obligations, resolving disputes, and enforcing our agreements. Because these needs can vary for different data types in the context of different products, actual retention periods can vary significantly. The criteria used to determine the retention periods include, for instance the period of your personal data processing needed to provide the services.`)}</p>
                    </div>
                    <div className="paragraph">
                        <p className="header">{t (`Data Security`)}</p>
                        <p className="text">{t (`We take appropriate technical and organizational measures to protect your personal information from unauthorized access, disclosure, alteration, and destruction.`)}</p>
                    </div>
                    <div className="paragraph">
                        <p className="header">{t (`Data Sharing`)}</p>
                        <p className="text">{t (`We do not sell, trade, or otherwise transfer your personal information to third parties without your explicit consent, except as required by law.`)}</p>
                        <p className="text">{t (`We may share information with third parties if the information is required to provide the service you have requested or to contact with you.`)}</p>
                        <p className="text">{t (`We reserve the right to disclose your personal data to third parties when required to do so by law to regulatory, law enforcement, or other government authorities.`)}</p>
                    </div>
                    <div className="paragraph">
